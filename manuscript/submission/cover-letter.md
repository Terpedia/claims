...
interaction, receptor function, biological phenotype, and translational
efficacy into a single label. We present a reproducible pharmacology-first
framework that converts a Terpedia promotional matrix into 109 marked
compound–effect hypotheses and links them to identity-aware receptor evidence.
The work explicitly separates compound-level target pharmacology from
...
validation. The manuscript is supported by versioned machine-readable data and
