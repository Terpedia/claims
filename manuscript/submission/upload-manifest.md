# Proposed Wiley Research Exchange upload set

Prepare these files from the repository root. The CSV files are supporting
data, not claims of efficacy; retain their provenance and evidence boundaries.
